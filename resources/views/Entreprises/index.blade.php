...
<!-- <script src="{{ asset('js/entrprise.js') }}"></script> -->
<style>
    .job-card-link {
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const jobDetailDescription = document.querySelector(".overview-text-subheader");
    const afficherBtn = document.getElementById("afficher-btn");
    ...
    jobCards.forEach((jobCard) => {
        jobCard.addEventListener("click", () => {
            ...
            const id = jobCard.dataset.id; // Get the id from the data attribute
            const secteur = jobCard.dataset.secteur; // Get the secteur from the data attribute
            const description = jobCard.dataset.description; 

            jobDetailDescription.textContent = description;
            afficherBtn.href = `/entreprises/${id}`;

            // jobDetailTitle.textContent = secteur; // Update the title in the job details
            // jobDetailSubtitle.textContent = description; // Update the subtitle in the job details

            const logo = jobCard.querySelector("svg");
            bg = logo.style.backgroundColor;
            console.log(bg);
...
$(document).ready(function () {
        $(document).on("click", ".job-card", function () {
            var entrepriseId = $(this).data("user-id");
            $("#modifier-btn").attr("href", "/entreprises/" + entrepriseId + "/edit");
            $("#modifier-btn-supp").attr("href", "/entreprises/" + entrepriseId + "/delete");
        });
    });

</script>
<div class="CRUDbutton">
    <button class="btn-index"><a href="/entreprises/create">Ajouter</a></button>
        ...
        <div class="searched-jobs">
          ...
          <div class="job-cards">
            ...
            <!-- <div class="job-card" data-user-id="{{ $ent->id }} "> -->
             <div class="job-card" data-user-id="{{ $ent->id }} " data-id="{{ $ent->id }}" data-secteur="{{ $ent->secteur }}" data-description="{{ $ent->description }}">
              ...
              <div class="job-card-title">{{ $ent->name }}</div>
              ...
              <div class="job-detail-buttons">
                <button class="search-buttons detail-button">
                    Average Rating: {{ $ent->received_evaluations_avg_rating ?? 'N/A' }} / 5
                </button>
                </button>
                <button class="search-buttons detail-button">
                  Full Time
          ...
          <div class="job-overview">
            <div class="job-overview-cards">
                @forEach ($entreprises as $ent)
              <div class="job-overview-card" data-user-id="{{ $ent->id }} " data-id="{{ $ent->id }}" data-secteur="{{ $ent->secteur }}" data-description="{{ $ent->description }}">
            ...
            <div class="job-explain">
              ...
              <div class="CRUDbutton">
                <button class="btn-index" ><a id="afficher-btn" href="">afficher</a></button>
              </div>
            </div>
          </div>
        </div>
