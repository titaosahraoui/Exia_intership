...
<div class="container">
    <form action="{{ route('offrestage.store') }}" method="POST" class="offre-stage-form">
        @csrf
        <h2>Create Offre de Stage</h2>
        ...
        <div class="form-group">
            ...
            <input type="text" id="competance" name="competance" class="form-control" required>
        </div>
